...
const DB_PATH = path.resolve(new URL(import.meta.url).pathname, '../../data/database.sqlite');
const OUTPUT_PATH = path.resolve(new URL(import.meta.url).pathname, '../../../frontend/src/data/footballData.js');
