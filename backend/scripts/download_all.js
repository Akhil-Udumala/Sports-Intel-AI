...
const players = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../data/all_players.json'), 'utf8'));
const outDir = path.resolve(__dirname, '../../frontend/public/images/players');
