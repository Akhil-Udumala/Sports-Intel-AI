...
const DATA_DIR = path.resolve(new URL(import.meta.url).pathname, '../../data/all_json');
const OUTPUT_PATH = path.resolve(new URL(import.meta.url).pathname, '../../../frontend/src/data/cricketData.js');
